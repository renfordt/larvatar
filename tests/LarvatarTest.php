...
class LarvatarTest extends TestCase
{
    public function testCreateLarvatar(): void
    {
        ...
        $this->assertEquals(
            '<?xml version="1.0" encoding="utf-8"?><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100" height="100"><circle cx="50" cy="50" r="50" style="fill: #e8d2dc" /><text x="50%" y="55%" style="fill: #690230; text-anchor: middle; dominant-baseline: middle; font-size: 50px">TN</text></svg>',
    ...
    public function testSetFont(): void
    {
        ...
        $this->assertEquals(
            '<?xml version="1.0" encoding="utf-8"?><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100" height="100"><circle cx="50" cy="50" r="50" style="fill: #e8d2dc" /><text x="50%" y="55%" style="fill: #690230; text-anchor: middle; dominant-baseline: middle; font-family: Roboto; font-size: 50px">TN</text></svg>',
            $larvatar->getImageHTML()
        );
    }
